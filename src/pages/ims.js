...
export default function About() {
  return (
    <Container>
      ...
      <Container2>
        <Heading1>
          <Logo src="/images/society/ims-logo.png" />
          <center><a href="https://ieee-ims.org/" target="_blank" rel="noreferrer"><Button >Go to Website</Button></a></center>
          </Heading1></Container2>
          <center><br/><br/>
          <ContainerMission>
          <Features>
      ...
      <Section>
        ...
        <Container1>
        <Member>
            <Image alt="" src="/images/ExCom_23/Malavika P Nair_.webp" />
            <Name>Malavika P Nair</Name>
<Position>Chairperson</Position>

          </Member>
          <Member>
            <Image alt="" src ="/images/ExCom_23/Sooraj SK .webp" />
            <Name>Sooraj S K</Name>
<Position>Vice Chairperson</Position>

          </Member>
          <Member>
          <Image alt="" src ="/images/ExCom_23/Navya Rajan_.webp" />
